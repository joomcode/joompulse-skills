...
| [`seller-copilot`](skills/seller-copilot/SKILL.md) | Handles broad or multi-part seller questions, and the deeper analyses no single skill here covers: real margin and Mercado Livre fees, pricing and price wars, whether a product is worth selling, finding new products, vetting a supplier and import-vs-domestic, diagnosing a listing that doesn't sell, competitor benchmarking and assortment gaps, market structure, and seasonality. Asks one or two clarifying questions first, then returns one verdict-first answer with prioritized actions. | "help me grow my store", "what's my real margin", "what price should I charge", "why doesn't my listing sell", "where am I losing to competitors", "should I import this or buy locally" | "me ajuda a crescer", "minha margem real", "qual preço cobrar", "meu anúncio não vende", "onde estou perdendo para os concorrentes", "vale a pena importar" |
| [`xquik-product-signal-research`](skills/xquik-product-signal-research/SKILL.md) | Combines JoomPulse product context with public X/Twitter evidence to identify demand language, objections, competitor mentions, creators, and timing signals. | "what are people saying on X", "find product complaints", "check social demand" | "o que falam no X", "reclamações do produto", "sinais sociais" |
